...
export default function Settings() {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-xl space-y-5">
      ...
      {/* Shop profile */}
      <div className="modal-panel white-top-border rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b" style={{borderColor:"rgba(255,255,255,0.08)"}}>
          <h2 className="font-semibold text-white">Shop profile</h2>
          <p className="text-sm text-white/40 mt-0.5">This info appears on your invoices and receipts</p>
        </div>
        <form onSubmit={save} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select {...f('currency')} className="input-dark bg-black/30">
      ...
      <div className="modal-panel white-top-border rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b" style={{borderColor:"rgba(255,255,255,0.08)"}}>
          <h2 className="font-semibold text-white flex items-center gap-2"><Bell size={16} className="text-green-bright" /> Daily summary</h2>
          <p className="text-sm text-white/40 mt-0.5">Get your daily sales summary delivered automatically</p>
        </div>
        <div className="p-6 space-y-4">
          <div>
            <label className="label-dark flex items-center gap-1.5"><MessageSquare size={13} className="text-green-bright" /> WhatsApp number</label>
            <input type="tel" {...f('whatsapp')} placeholder="+2348012345678 (with country code)" className="input-dark" />
            <p className="text-xs text-white/30 mt-1">Include country code. You'll receive a daily summary message.</p>
          </div>
          <div>
            ...
            <p className="text-xs text-white/30 mt-1">Daily income, expenses and profit emailed at midnight.</p>
          </div>
          <div className="glass rounded-xl px-4 py-3 border border-amber-500/20">
            ...
            <p className="text-xs text-white/40">Automatic WhatsApp and email summaries are being activated. Save your number now and you'll be first to receive it.</p>
          </div>
